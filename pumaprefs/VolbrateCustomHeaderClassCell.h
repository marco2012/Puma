...
- (id)init {
       ...
       if (self) {
            ...
            [self.headerLabel setTextColor:[UIColor colorWithRed:1.00 green:0.78 blue:0.00 alpha:1.0]];
            ...
            [self.subHeaderLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:18]];
            [self.subHeaderLabel setText:@"Make your device perpendicolare"];
            ...
            [self.subHeaderLabel setTextColor:[UIColor colorWithRed:1.00 green:0.78 blue:0.00 alpha:1.0]];
